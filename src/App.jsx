...
function App() {
  ...
  <Navbar/>
   {
    showPopup && <div className="w-full h-full flex justify-center items-center fixed z-50  backdrop-blur-md top-0 ">
      ...
      {/* <div className="bg-red-700 p-3 rounded-lg absolute top-0 right-0 cursor-pointer" onClick={closePopup}><IoMdClose className="text-white text-[1rem]"/></div> */}
