...
export default function FooterDel() {
  return (
    <div className="w-auto relative h-auto bg-[#064DAB]">
    <div className="custom-shape-divider-top-1688619222">
  <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
    <path d="M0,0 C300,100 900,-50 1200,60 L1200,120 L0,120 Z" className="shape-fill fill-white"></path>
  </svg>
</div>
...
{/* next section */}
  ...
  <Link to="/about"><h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>About Us</h2></Link>      
        <Link to="/pricing">      <h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>Pricing</h2> </Link>
    ...
    <Link to="/about">  <h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>
     ...
     <Link to="/refund-policy">   <h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>
      ...
      <div data-aos="fade-up" className="w-[300px] h-auto mx-auto text-center">
        ...
        <div className="pt-1">
     <Link to="/blog">   <h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>Blogs</h2></Link>  
       <Link to="#"> <h2 className="text-[16px] font-[200] text-[#ffffff]" style={{fontFamily: "'Poppins', sans-serif"}}>
            Use-Cases
          </h2></Link>  
        </div>
      ...
      <div data-aos="fade-up" className=" lg:w-[1140px] lg:flex mt-7 space-y-6 lg:space-y-0">
        <div className="w-[300px] text-center lg:px-4 h-auto mx-auto">
          <ul>
         <Link to="#">   <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Dhanbad</li> </Link>
         <Link to="/bulk-sms-provider-in-surat">   <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Surat</li> </Link>
         <Link to="#">   <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Meerut</li> </Link>
         <Link to="/bulk-sms-provider-in-rajasthan">   <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>
              Bulk SMS Provider in Rajasthan
            </li> </Link>
          </ul>
        </div>
        ...
        <div data-aos="fade-up" className="w-[300px] lg:px-4 text-center  h-auto mx-auto">
         ...
         <Link to="#"> <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Kanpur</li></Link>  
          <Link to="/bulk-sms-provider-in-ahmedabad"> <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>
        ...
        <div data-aos="fade-up" className="w-[300px] lg:px-4 text-center h-auto mx-auto">
          <ul>
          <Link to="/bulk-sms-provider-in-gaya">  <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Gaya</li>  </Link>
          <Link to="/bulk-sms-provider-in-hyderabad">  <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>  Bulk SMS Provider in Hyderabad </li>  </Link>
          <Link to="/bulk-sms-provider-in-mumbai">  <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Mumbai</li>  </Link>
          <Link to="/bulk-sms-provider-in-pune">  <li className="text-yellow-500 font-semibold " style={{fontFamily: "'Poppins', sans-serif"}}>Bulk SMS Provider in Pune</li>  </Link>
          </ul>
        </div>
        {/* eleventh */}
        ...
        <div data-aos="fade-up" className="w-[300px] lg:px-4 text-center h-auto mx-auto">
          <ul>
          <Link to="/bulk-sms-provider-in-bangalore">  <li className="text-yellow-500 font-semibold" style={{fontFamily: "'Poppins', sans-serif"}}>  Bulk SMS Provider in Bangalore  </li>  </Link>
    ...
    <div className='lg:w-[1200px] lg:flex  lg:mx-auto lg:h-auto '>
      ...
      <div data-aos="fade-right" className="w-[310px] z-10 h-auto p-7 lg:pl-14 mt-5 lg:w-[1400px] mx-auto lg:-ml-1  lg:gap-x-2  bg-white lg:grid lg:grid-cols-3">
        ...
        <p className='text-[#0b439a] px-6  text-center lg:text-left' style={{fontFamily: "'Poppins', sans-serif"}}>
          DIGINTRA Inc. (referred as "DIGINTRA") , founded in 2015 with the
...
<h2 className='text-[#0b439a] text-[20px] text-center font-[600] border-b-2 py-1 my-2 border-[#00D180] lg:mt-5' style={{fontFamily: "'Poppins', sans-serif"}}>Contact Us</h2>
...
<span className='text-[10px] font-[400]'> All Rights Reserved</span></h1>
    </div>
