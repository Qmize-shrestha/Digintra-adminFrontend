  ...
  return (
   <div className='w-[100%] h-screen fixed  z-50' onClick={onClose}>
    <div className='w-[300px] h-auto bg-blue-50  right-[4rem] absolute border-b-8 border-blue-800 '>
     ...
     <a href="https://www.connect.digintra.com/login">  <li className='text-left flex items-center gap-5 my-[2rem] hover:scale-105 transition-transform' style={{fontFamily:"'Poppins',sans-serif"}}><IoLogoWhatsapp className='text-[1rem] text-green-800'/> WhatsApp Login</li> </a> 
